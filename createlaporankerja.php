...
<head>
	<meta charset="UTF-8">
	<title>Create Laporan Kerja</title>
...
<body>
	<div id="content">
		<center>
		<h2>Buat Laporan Kerja</h2><hr /><br />
			<h1 id="laporankerja"></h1>
			Masukan Laporan Kerja : 
			<textarea name="laporankerja" rows="2" COLS="30"></textarea>
			<!--<input type="button" value="KIRIM" id="btn" onClick="tesclick()">-->

		    <br>
		    Upload Foto Laporan Kerja : <input type="file" id="images">
			<input type="button" value="KIRIM" id="btn" onClick="tesclick()">			
